    ...
    <div class="container">
        <div class="register-form mt-1">
            <form method="post">
                ...
                <div class="mb-3">
                    <input class="form-control" type="text" name="login" placeholder="<?=lang('register', 'login')?>" value="<?=$return->data->login?>">
                </div>
                <div class="mb-3">
                    <input class="form-control" type="email" name="email" placeholder="<?=lang('register', 'email')?>" value="<?=$return->data->email?>">
                </div>
                <div class="mb-3">
