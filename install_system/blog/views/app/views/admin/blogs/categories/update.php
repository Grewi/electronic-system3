                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3 form-floating">
                            <select class="form-select" name="sort_post">
                                <option ></option>
                                <option value="id" <?=$return->data->sort_post == 'id' ? 'selected' : ''?>>id</option>
                                <option value="date_create" <?=$return->data->sort_post == 'date_create' ? 'selected' : ''?>>Дата создания</option>
                                <option value="sort" <?=$return->data->sort_post == 'sort' ? 'selected' : ''?>>Метка сортировки</option>
                            </select>
